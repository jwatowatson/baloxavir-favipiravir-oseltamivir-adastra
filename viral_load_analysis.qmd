...
if (use_threshold) {
  ...
  ff = list.files('Rout/', pattern = paste0(intervention, "_mITT", '_vs_', ifelse(ref_arm == "No Study Drug", "NSD", ref_arm), '.RData'))
}
...
write.csv(
  Half_life_dat,
  "D:/baloxavir-favipiravir-oseltamivir-adastra/Analysis_Data/Half_life_dat.csv",
  row.names = FALSE
)
```
...
png(plot_name, width = 12, height = 6, units = "in", res = 600)
